...
class _$BookImpl with DiagnosticableTreeMixin implements _Book {
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Book(bookID: $bookID, imageURL: $imageURL, title: $title, desc: $desc, notes: $notes, startDate: $startDate, isFavorite: $isFavorite)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, bookID, imageURL, title, desc, notes, startDate, isFavorite);
